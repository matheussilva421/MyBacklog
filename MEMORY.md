...
## Project Memories
- [Sync Improvements Phase 1](memory/sync-improvements-phase1.md) - Melhorias de sync implementadas em 2026-03-21: localRevision, deviceId, lock entre abas, debounce
- [Sync Phase 2 Schema](memory/sync-phase2-schema.md) - Schema atualizado com uuid, version, deletedAt em todas as entidades syncáveis
